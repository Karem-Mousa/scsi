...
class Saudi(models.Model):
    ...
    type_gosi =fields.Char(string='Type', required=True, tracking=True) # track_visibility='onchange'
    dob = fields.Char(string='Date Of Birth', required=True)
    gos_numb = fields.Char(string='GOSI Number', required=True, tracking=True) # track_visibility='onchange'
    issued_dat =fields.Char(string='Issued Date', required=True, tracking=True) # track_visibility='onchange'
