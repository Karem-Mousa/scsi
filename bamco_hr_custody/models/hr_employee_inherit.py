...
class HrEmployee(models.Model):
    ...
    employee_custody_ids = fields.One2many(comodel_name="hr.custody", inverse_name="employee_id", string="",
                                           required=False, )
    employee_mobile_ids = fields.One2many(comodel_name="mobile.set", inverse_name="employee_id", string="",
                                          required=False, )
