...
class HrCustody(models.Model):
    ...
    status = fields.Selection(string="Status When Returned",
                              selection=[('good', 'Good and Working'), ('fix', 'Need Some Fix'), ('scrap', 'Scrap')],
                              required=False, )
    state = fields.Selection(string="State",
                             selection=[('draft', 'Draft'), ('delivered', 'Delivered'), ('return', 'Returned'), ],
                             default='draft')
    delivered_attachment = fields.Binary('Delivered Attachment')
    returned_attachment = fields.Binary('Returned Attachment')
